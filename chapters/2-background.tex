...
\editor{Maybe need a section on ray casting, ray marching, and rasterization?}


\section{The Many Els}

Many computer graphics techniques involve breaking down complex objects into many individual elements.
...
In this case, a picture has been broken down into individual elements.
In this paper, we will discuss pixels and other such broken down elements including:
