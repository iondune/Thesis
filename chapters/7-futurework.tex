...
Using a GPU ray-cast simulation of forests would produce much larger view distances and improved visual approximation. \editor{cite the paper that did this}
